...
import com.example.as2.databinding.JavanoteBinding
import com.example.as2.model.information

class javaAdapter (var activity: Activity, private var data: ArrayList<information>) :
    RecyclerView.Adapter<javaAdapter.MyViewHolder>() {
    class MyViewHolder(var binding: JavanoteBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = JavanoteBinding.inflate(activity.layoutInflater,parent,false)
